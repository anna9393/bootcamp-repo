...
app.get('/', (req, res) => {
    let fltrdDrinks = cocktails.filter((cocktail) => req.query.alcohol ? cocktail.contains.includes(req.query.alcohol) : true);
    res.render('home', { drinks: fltrdDrinks, list: alcoholList });
});
